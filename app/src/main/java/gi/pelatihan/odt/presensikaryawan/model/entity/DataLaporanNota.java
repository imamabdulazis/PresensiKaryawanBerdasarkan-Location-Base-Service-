...
public class DataLaporanNota {
	...
	public void setJenisKlaim(String jenisKlaim) {
		this.jenisKlaim = jenisKlaim;
	}
	...
	@Override
 	public String toString(){
		return 
			...
			",id_klaim_bbm_detail = '" + idKlaimBbmDetail + '\'' + 
			...
			",id_klaim_bbm = '" + idKlaimBbm + '\'' + 
			",jumlah_approv = '" + jumlahApprov + '\'' + 
			",tgl_approv = '" + tglApprov + '\'' + 
			"}";
		}
}